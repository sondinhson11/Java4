...
public class ChiTietSPServlet extends HttpServlet {
    ...
    public ChiTietSPServlet() {
        ...
        this.ctrp.insert(new ChiTietSP("SP1",2003,"aaa",100,200000,300000));
        this.ctrp.insert(new ChiTietSP("SP2",2003,"aaa",100,200000,300000));
    }
    ...
    protected void delete(
        ...
        if(ctsp == null){
            ...
            response.sendRedirect("/Java4_BTVN_war_exploded/chitiet-sp/index");
        }
    }
    protected void eidt(
            HttpServletRequest request,
